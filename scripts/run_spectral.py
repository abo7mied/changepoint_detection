"""Run the spectral-mixture experiment."""
...
NUM_REGIMES = 2
SAMPLING_RATE = 512.0
SPECTRAL_AR_DAMPING = 2.0
SPECTRAL_FILTER_ORDER = 4
SPECTRAL_BURN_IN = 1000
...
SAVE_COEFFICIENT_HEATMAPS = True


# --- 4: Output and Spectral Structure ---
...
def configured_spectral_experiments():
    experiments = list(
        build_spectral_coefficient_experiments(
            EXPERIMENT_PARAMETERS,
    ...
    experiments.extend(
        ...
        for dimension in DIMENSION_SIZES
    )
...
SPECTRAL_EXPERIMENTS = (
    configured_spectral_experiments()
)
